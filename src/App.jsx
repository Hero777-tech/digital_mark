  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <BrowserRouter>
        <Header />
        <Routes>
          <Route path="/digital_mark/" element={<Home />} />
          <Route path="/digital_mark/about" element={<About />} />
          <Route path="/digital_mark/service" element={<Services />} />
          <Route path="/digital_mark/contact" element={<Contact />} />
          {/* <Route path="/Prot" element ={<Prot/>} /> */}
          <Route path="/Treams" element={<Teams/>} />
          <Route path="/Testx" element={<Testx/>} />
          <Route path="/digital_mark/Protf" element={<Protf/>} />
